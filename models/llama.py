...
class Llama3Model(nn.Module):
    def __init__(self, cfg):
        ...
        self.tok_emb = nn.Embedding(num_embeddings=128_256, embedding_dim=2048, dtype=torch.bfloat16)
        self.trf_blocks = nn.ModuleList([TransformerBlock(cfg) for _ in range(16)])
        self.final_norm = nn.RMSNorm(emb_dim=2048, eps=1e-5, dtype=torch.bfloat16)
